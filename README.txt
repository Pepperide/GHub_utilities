...
GHub Utility tools provide software to improve user experience to the usage of Logitech© products.

Update 18/02/2022 v1.0.0:
-   pop-up.py script is able to show to the user some informations sent from the Logitech© G HUB© platform.
...
-   To hide the console window save the script as .pyw extention intead of .py